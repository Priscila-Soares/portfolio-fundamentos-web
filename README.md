...
1. Clone o repositório:
	```bash
   git clone https://github.com/Priscila-Soares/portfolio-fundamentos-web.git
```
2. Abra o projeto no Visual Studio Code:
   ```bash
   code portfolio-fundamentos-web
```
...
- [Portfólio Pessoal](https://github.com/Priscila-Soares/portfolio-fundamentos-web.git)
